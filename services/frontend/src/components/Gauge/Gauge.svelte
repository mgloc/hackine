...
<script>
    ...
    let color = percentage > max ? "#A10202" : "#679289"
...
<div class="main">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="37 -5 120 100" width="240" height="200">
        ...
        <line style="stroke:{color}" x1="97" y1="55" x2="{getX()}" y2="{getY()}" stroke="#000" stroke-width="3" marker-end="url(#{percentage > max ? "redArrow" : "greenArrow"})" />
        <path class="grey" d="M55,90 A55,55 0 1,1 140,90" style="fill:none;"/>
        <path class="inner" d="M55,90 A55,55 0 1,1 140,90" style="fill:none;stroke-dashoffset:{248 * (1 - percentage / 100)};stroke:{color}"/>
        <circle fill="{color}" cx="97" cy="55" r="5"/>
    </svg>
    <h1>{percentage}%</h1>
</div>
